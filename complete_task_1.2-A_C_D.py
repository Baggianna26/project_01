...
# ПОЯСНЕНИЕ по выбору стратегии решения

# 1. Поскольку в задании фигурирует выборка трех песен из имеющегося списка,
# в процессе решения задачи принято условие исключения возможности дублирования песен в выборке
# Т.е. каждая песня в выборке уникальна и не повторяется.

#2. При построеии стратегии решения принято условие сохранения работоспособности программы
# для любого размера списка, в пределах ресурса интерпритатора и машины, а так же любого размера выборки,
# от 1 до равного количеству записей в списке.