...
# 1. Поскольку в задании фигурирует выборка трех песен из имеющегося словаря,
...
# для любого размера словаря, в пределах ресурса интерпритатора и машины, а так же любого размера выборки,
# от 1 до равного количеству записей в словаре.